...
public abstract class AbsNetResultRequest<T> extends AbsResultRequest<T> implements ResultRequest {

    public AbsNetResultRequest(final ResponseListener listener) {
        super(listener);
    }
